...
- Diffusion milestone coverage is now **10/24 complete**, with **9/24 explicitly deferred** and **1/24 partially backfilled** because some higher thresholds are not reached in the chosen series.
...
- Diffusion milestone backfilling remains incomplete for 4 profiles, with 9 additional profiles intentionally deferred and 1 partially backfilled pending better series, observed threshold crossings, or a narrower metric definition.
